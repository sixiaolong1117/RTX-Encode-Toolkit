...
rem Export local video with NVIDIA RTX Video Super Resolution via rigaya NVEncC.
...
if not defined RTX_NVENC_QVBR set "RTX_NVENC_QVBR=22"
...
set "out=%outdir%\%base%_rtx_vsr_%RTX_VSR_RES%_hevc10.mkv"

echo.
echo [RTX VSR NVEncC] "%in%"
echo Output: "%out%"
